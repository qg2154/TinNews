...
public class SavedNewsAdapter extends RecyclerView.Adapter<SavedNewsAdapter.SavedNewsViewHolder> {
   //fragment 传进来
    ...
    public void setOnClickListener(OnClickListener listener) {
        ...
        public void onBindViewHolder(@NonNull SavedNewsViewHolder holder, int position) {
                ...
                holder.description.setText(article.description);
                        ...
                        //每一个holder都有自己独立的instance，独一无二的icon 和 setOnClickListener
    ...
    //This static class will be used as Adapter's RecyclerView ViewHolder
